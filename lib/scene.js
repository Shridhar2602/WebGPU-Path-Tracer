...
export class Scene {
	...
	create_spheres() {
		...
		this.spheres.push(
			...
			// new Sphere([0.25, -0.7, 0.3], 0.3, this.global_id++, this.sphere_id++, this.add_material("yellow_ball", 0, [0.95, 0.95, 0.95], [1, 1, 1], [0, 0, 0], 0, 0, 0)),
		)
	...
	create_quads() {
		...
		this.quads.push(
			...
			new Quad([-0.35, 1, -0.3],[0.7, 0, 0], [0, 0, 0.6], this.global_id++, this.quad_id++, this.add_material("light", 0, [0, 0, 0], [0, 0, 0], [6, 6, 6], 0, 0, 0)), //light  // 13
	...
	create_meshes() {
		...
		this.meshes.push(
			new Mesh(this.mesh_data["cube"], this.triangle_offset, this.global_id++, this.mesh_id++, this.triangle_id, this.add_material("glassBox", 0, [0.95, 0.95, 0.95], [0, 0, 0], [0, 0, 0], 0, 0, 0))
		)

		this.triangle_id += this.meshes[0].numTriangle;
		this.triangle_offset += this.meshes[0].numTriangle;
		this.meshes.push(
			new Mesh(this.mesh_data["cube"], this.triangle_offset, this.global_id++, this.mesh_id++, this.triangle_id, this.add_material("box2", 0, [0.95, 0.95, 0.95], [1, 1, 1], [0, 0, 0], 0, 0, 0))
		)
