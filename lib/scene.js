...
export class Scene {
	...
	create_meshes() {
		...
		this.meshes.push(
			new Mesh(this.mesh_data["bunny"], this.triangle_offset, this.global_id++, this.mesh_id++, this.triangle_id, this.add_material("glassBox", 0, [0.7, 0.7, 0.3], [0.95, 0.95, 0.95], [0, 0, 0], 0, 0, 1.5))
		)

		this.triangle_id += this.meshes[0].numTriangle;
		this.triangle_offset += this.meshes[0].numTriangle;
		// this.meshes.push(
		// 	new Mesh(this.mesh_data["armadillo"], this.triangle_offset, this.global_id++, this.mesh_id++, this.triangle_id, this.add_material("box2", 0, [0.95, 0.95, 0.95], [0.95, 0.95, 0.95], [0, 0, 0], 0, 0, 0))
		// )
		...
		// this.meshes[0].transform.update(
		// 	this.meshes[0].transform.scale(1, 1, 1),
		// 	this.meshes[0].transform.translate(0.05, -0.67, 0),
		// )
